...
class AemsPlanningPackageController extends Controller
{
    ...
    private function content(Request $request): array
    {
        return $request->validate([
            ...
            'riskMatrix' => ['nullable','array'], 'riskMatrix.code' => ['nullable','string','max:80'], 'riskMatrix.title' => ['nullable','string','max:255'], 'riskMatrix.methodology' => ['nullable','string','max:10000'], 'riskMatrix.riskAppetite' => ['nullable','string','max:100'], 'riskMatrix.overallConclusion' => ['nullable','string','max:10000'],
