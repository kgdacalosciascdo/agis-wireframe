...
class RolePermissionSeeder extends Seeder
{
    ...
    private array $permissionCatalogue = [
        ...
        'aems.evidence' => ['view', 'upload', 'verify', 'void', 'assess', 'exception_approve'],
        'aems.evidence-request' => ['view', 'create', 'update', 'submit', 'send', 'receive', 'assess', 'close'],
        'aems.issue' => ['view', 'create', 'validate', 'dismiss', 'convert', 'merge', 'resolve', 'observe', 'refer', 'close_without_finding'],
        ...
        $roles = [
            ...
            'agis_user' => [
                ...
                'permissions' => [
                    ...
                    'aems.evidence-request.submit', 'aems.evidence-request.send', 'aems.evidence-request.receive',
                    'aems.evidence-request.assess',
                    'aems.issue.view', 'aems.issue.create', 'aems.issue.validate',
                    'aems.issue.merge', 'aems.issue.resolve', 'aems.issue.observe', 'aems.issue.refer', 'aems.issue.close_without_finding',
                    ...
                    'aems.report.withdraw', 'aems.report.supersede',
