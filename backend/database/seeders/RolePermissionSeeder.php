...
class RolePermissionSeeder extends Seeder
{
    ...
    private array $permissionCatalogue = [
        ...
        'armis' => [
            ...
            'actuals.view', 'actuals.record', 'actuals.review', 'actuals.approve',
        ...
        $roles = [
            ...
            'agis_user' => [
                ...
                'permissions' => [
                    ...
                    'armis.workload.view', 'armis.actuals.view', 'armis.actuals.record',
                    'arms.view', 'ais.view',
            ...
            'read_only' => [
                ...
                'permissions' => [
                    ...
                    'armis.capacity.view', 'armis.workload.view', 'armis.actuals.view',
                    'aems.report.view_issued',
