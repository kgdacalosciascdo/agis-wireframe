...
class CoreModuleTest extends TestCase
{
    ...
    public function test_realistic_core_records_are_seeded_with_relationships(): void
    {
        ...
        $this->assertDatabaseCount('system_configurations', 35);
    ...
    public function test_core_registry_access_is_enforced_by_role(): void
    {
        ...
        $this->getJson('/api/permissions')->assertOk()->assertJsonCount(349, 'data.permissions');
        ...
        $this->getJson('/api/system-configurations')->assertOk()->assertJsonCount(35, 'data.configurations');
